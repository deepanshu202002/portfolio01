        ...
        <div className={cn("relative block md:hidden", className)}>
            <AnimatePresence>
                {open && (
                    <motion.div
                        layoutId="nav"
                        className="absolute bottom-full mb-4 left-1/2 -translate-x-1/2 flex flex-row gap-2 bg-neutral-50/90 dark:bg-neutral-900/90 backdrop-blur-md p-2 rounded-2xl border border-neutral-200 dark:border-neutral-800"
                    >
                        {items.map((item, idx) => (
                            <motion.div
                                key={item.title}
                            ...
                            >
                                <Link
                                    href={item.href}
                                    key={item.title}
                                    className="h-10 w-10 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
                                >
